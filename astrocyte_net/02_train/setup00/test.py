...
val_zarr_path = os.path.join(val_data_dir, val_zarr_name)

test_zarr_name = "Astro_raw_gt_test_0.zarr"
test_zarr_path = os.path.join(test_data_dir, test_zarr_name)

predict_zarr_name = "Astro_predict_0.zarr"
predict_zarr_path = os.path.join(predict_data_dir, predict_zarr_name)
